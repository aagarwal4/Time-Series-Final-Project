...
d_mul <- data.frame(alpha = OrderGrid[,1], beta = OrderGrid[,2], gamma = OrderGrid[,3], rmse_hw_mult)
d_mul[order(d_mul$rmse_hw_mult),]
```

### Choose the optimal Holt-Winters model
```{r}
##Multiplicative Holt-Winters approach
optimal.hw <- HoltWinters(x = y.train, alpha = 0.6, beta = 0.6, gamma = 0.8, seasonal = 'mult')
