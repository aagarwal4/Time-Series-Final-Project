...
```{r}
data <- read.csv("/Users/anantagarwal/Desktop/MSAN/Module2/Time_Series/Final Project/train.csv", header = TRUE,sep = ",") # 1987 - 2010
data <- data[which(is.na(data['Month']) == 0),] #remove blank lines at bottom
test <- read.csv("/Users/anantagarwal/Desktop/MSAN/Module2/Time_Series/Final Project/test.csv") # 2011, 2012
```
...
d <- data.frame(alpha = OrderGrid[,1], beta = OrderGrid[,2], gamma = OrderGrid[,3], rmse_hw_add)
d[order(d$rmse_hw_add),]
